...
function App() {
  ...
  const getEmpleados = () =>{
    Axios.get("http://146.235.205.235:3000/empleados").then((response)=>{
  ...
  const insertar = () =>{
    Axios.post("http://146.235.205.235:3000/create",{
      manager:manager,
  ...
  const update = () =>{
    Axios.put("http://146.235.205.235:3000/update",{
      id:id,
      manager:manager,
      departamento:departamento,
      puesto:puesto,
  ...
  const deleteEmple = (val) =>{
    Axios.delete(`http://146.235.205.235:3000/delete/${val.id_empleado}`).then(()=>{
      getEmpleados();
      limpiarCampos();
    });
  }
